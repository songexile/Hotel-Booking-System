...
//CREATE TABLES
    public static final String createGuest = "CREATE TABLE GUESTS (FIRSTNAME VARCHAR(30) NOT NULL, LASTNAME VARCHAR(30) NOT NULL, PHONE VARCHAR(15) NOT NULL, ROOMNUM INT)";
    public static final String roomTable = "CREATE TABLE ROOMS (PRICE INT NOT NULL, ISRESERVED SMALLINT NOT NULL, CURRENTGUESTSTAYING VARCHAR(60), CHECKIN DATE, CHECKOUT DATE)";
